/*! Pickr 1.4.7 MIT | https://github.com/Simonwep/pickr */ ! function(t, e) {
    ...
    return function(t) {
                    ...
                    toCMYK() {
                        const t = function(t, e, o) {
                            const n = w(t, e, o),
                                ...
                                s = n[2] / 255;
                            let c, a, l, p;
                            return [100 * (a = 1 === (c = b(1 - i, 1 - r, 1 - s)) ? 0 : (1 - i - c) / (1 - c)), 100 * (l = 1 === c ? 0 : (1 - r - c) / (1 - c)), 100 * (p = 1 === c ? 0 : (1 - s - c) / (1 - c)), 100 * c]
                        }(r.h, r.s, r.v);
        ...
        class D {
            constructor(t) {
                H(this, "_initializingActive", !0), H(this, "_recalc", !0), H(this, "_color", x()), H(this, "_lastColor", x()), H(this, "_swatchColors", []), H(this, "_eventListener", {
                    init: [],
                    save: [],
                    hide: [],
                    show: [],
                        ...
                        palette: L({
                            ...
                            onchange(o, n) {
                                ...
                                for (const {
                                        el: e,
                                        color: o
                                    } of t._swatchColors) e.classList[l === o.toHEXA().toString() ? "add" : "remove"]("pcr-active");
