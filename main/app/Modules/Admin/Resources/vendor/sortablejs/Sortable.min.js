/*! Sortable 1.10.1 - MIT | git://github.com/SortableJS/Sortable.git */ ! function(t, e) {
                ...
                if (mt = !1, c && !e.disabled && (u ? d || (r = !q.contains(z)) : it === this || (this.lastPutMode = ot.checkPull(this, c, z, n)) && t.checkPut(this, c, z, n))) {
                    ...
                    if (!g || function(t, e, n) {
                        ...
                        if (ht !== s && (m = i[E], yt = !1, wt = !w && e.invertSwap || y), 0 !== (v = function(t, e, n, o, i, r, a, l) {
                            ...
                            for (var S = F(z); S -= v, (b = G.children[S]) && ("none" === R(b, "display") || b === U););
        ...
        return t.prototype = {
            ...
            setupClone: function(t) {
                var e = t.sortable,
                    n = t.cancel;
                if (this.isMultiDrag) {
                    for (var o = 0; o < se.length; o++) ce.push(_(se[o])), ce[o].sortableIndex = se[o].sortableIndex, ce[o].draggable = !1, ce[o].style["will-change"] = "", k(ce[o], this.options.selectedClass, !1), se[o] === re && k(ce[o], this.options.chosenClass, !1);
                    e._hideClone(), n()
                }
            },
            clone: function(t) {
            ...
            _deselectMultiDrag: function(t) {
                if (!he && ie === this.sortable && !(t && P(t.target, this.options.draggable, this.sortable.el, !1) || t && 0 !== t.button))
                    for (; se.length;) {
                        var e = se[0];
