    ...
    return function e(t, n, r) {
        ...
        3: [function(e, t, n) {
            (function(t) {
                ...
                var r = e("base64-js"),
                    i = e("ieee754"),
                    o = "function" == typeof Symbol ? Symbol.for("nodejs.util.inspect.custom") : null;
                ...
                function l(e, n, r) {
                    ...
                    if (W(e, ArrayBuffer) || e && W(e.buffer, ArrayBuffer)) return function(e, n, r) {
                    ...
                    var o = function(e) {
                        ...
                        if (void 0 !== e.length) return "number" != typeof e.length || j(e.length) ? s(0) : h(e);
                ...
                function h(e) {
                    for (var t = e.length < 0 ? 0 : 0 | f(e.length), n = s(t), r = 0; r < t; r += 1) n[r] = 255 & e[r];
                    return n
                }
                ...
                function g(e, n, r, i, o) {
                    ...
                    if ("string" == typeof r ? (i = r, r = 0) : r > 2147483647 ? r = 2147483647 : r < -2147483648 && (r = -2147483648), j(r = +r) && (r = o ? 0 : e.length - 1), r < 0 && (r = e.length + r), r >= e.length) {
                        if (o) return -1;
                        r = e.length - 1
                    } else if (r < 0) {
                        if (!o) return -1;
                ...
                n.kMaxLength = a, t.TYPED_ARRAY_SUPPORT = function() {
                    ...
                    if (W(e, Uint8Array) && (e = t.from(e, e.offset, e.byteLength)), W(n, Uint8Array) && (n = t.from(n, n.offset, n.byteLength)), !t.isBuffer(e) || !t.isBuffer(n)) throw new TypeError('The "buf1", "buf2" arguments must be one of type Buffer or Uint8Array');
                    if (e === n) return 0;
                    ...
                    for (r = 0; r < e.length; ++r) {
                        var a = e[r];
                        if (W(a, Uint8Array) && (a = t.from(a)), !t.isBuffer(a)) throw new TypeError('"list" argument must be an Array of Buffers');
                    ...
                    if (W(e, Uint8Array) && (e = t.from(e, e.offset, e.byteLength)), !t.isBuffer(e)) throw new TypeError('The "target" argument must be one of type Buffer or Uint8Array. Received type ' + typeof e);
                ...
                t.prototype.slice = function(e, n) {
                    ...
                    if (this === e && "function" == typeof Uint8Array.prototype.copyWithin) this.copyWithin(n, r, i);
                        ...
                        for (var a = o - 1; a >= 0; --a) e[a + n] = this[a + r];
            ...
            (function(e) {
                ...
                function l(e, l, u, c) {
                    ...
                    this.atOccurrence = !1, this.doc = e, u = u ? e.clipPos(u) : r(0, 0), this.pos = {
                        from: u,
                        to: u
                    }, "object" == typeof c ? h = c.caseFold : (h = c, c = null), "string" == typeof l ? (null == h && (h = !1), this.matches = function(i, o) {
                        return (i ? function(e, i, o, a) {
                            if (!i.length) return null;
                            var l = a ? t : n,
                                u = l(i).split(/\r|\n\r?/);
                            e: for (var c = o.line, h = o.ch, f = e.firstLine() - 1 + u.length; c >= f; c--, h = -1) {
                                var d = e.getLine(c);
                                h > -1 && (d = d.slice(0, h));
                                var p = l(d);
                                if (1 == u.length) {
                                    var m = p.lastIndexOf(u[0]);
                                    if (-1 == m) continue e;
                                    return {
                                        from: r(c, s(d, p, m, l)),
                                        to: r(c, s(d, p, m + u[0].length, l))
                                    }
                                }
                                var g = u[u.length - 1];
                                if (p.slice(0, g.length) == g) {
                                    var v = 1;
                                    for (o = c - u.length + 1; v < u.length - 1; v++)
                                        if (l(e.getLine(o + v)) != u[v]) continue e;
                                    var y = e.getLine(c + 1 - u.length),
                                        x = l(y);
                                    if (x.slice(x.length - u[0].length) == u[0]) return {
                                        from: r(c + 1 - u.length, s(y, x, y.length - u[0].length, l)),
                                        to: r(c, s(d, p, g.length, l))
                                    }
                                }
                            }
                        } : function(e, i, o, a) {
                            ...
                            var l = a ? t : n,
                                u = l(i).split(/\r|\n\r?/);
                            e: for (var c = o.line, h = o.ch, f = e.lastLine() + 1 - u.length; c <= f; c++, h = 0) {
                                var d = e.getLine(c).slice(h),
                                    p = l(d);
                                if (1 == u.length) {
                                    var m = p.indexOf(u[0]);
                                    if (-1 == m) continue e;
                                    return o = s(d, p, m, l) + h, {
                                        from: r(c, s(d, p, m, l) + h),
                                        to: r(c, s(d, p, m + u[0].length, l) + h)
                                    }
                                }
                                var g = p.length - u[0].length;
                                if (p.slice(g) == u[0]) {
                                    for (var v = 1; v < u.length - 1; v++)
                                        if (l(e.getLine(c + v)) != u[v]) continue e;
                                    var y = e.getLine(c + u.length - 1),
                                        x = l(y),
                                        b = u[u.length - 1];
                                    if (x.slice(0, b.length) == b) return {
                                        from: r(c, s(d, p, g, l) + h),
                                        to: r(c + u.length - 1, s(y, x, b.length, l))
                                    }
                                }
                            }
                        })(e, l, o, h)
        ...
        10: [function(e, t, n) {
            (function(e) {
                ...
                function t(e) {
                    e.state.markedSelection && e.operation(function() {
                        ! function(e) {
                            ...
                            o(t, u.from) < 0 && (u.to.line - t.line < r ? (i.shift().clear(), a(e, t, u.to, 0)) : a(e, t, u.from, 0));
                            for (; o(n, c.to) < 0;) i.pop().clear(), c = i[i.length - 1].find();
                ...
                function a(e, t, n, a) {
                    if (0 != o(t, n))
                        for (var s = e.state.markedSelection, l = e.state.markedSelectionStyle, u = t.line;;) {
        ...
        11: [function(e, t, n) {
            ! function(e, r) {
                ...
                function oe(e, t, n) {
                    for (;
                        (n < 0 ? t > 0 : t < e.length) && ie(e.charAt(t));) t += n;
                    return t
                }
                ...
                var ue = function() {
                    ...
                    return function(l, u) {
                        ...
                        for (var h, f = l.length, d = [], p = 0; p < f; ++p) d.push((h = l.charCodeAt(p)) <= 247 ? e.charAt(h) : 1424 <= h && h <= 1524 ? "R" : 1536 <= h && h <= 1785 ? t.charAt(h - 1536) : 1774 <= h && h <= 2220 ? "r" : 8192 <= h && h <= 8203 ? "w" : 8204 == h ? "b" : "L");
                        ...
                        for (var S = 0; S < f; ++S) {
                            ...
                            if ("," == L) d[S] = "N";
                                ...
                                var T = void 0;
                                for (T = S + 1; T < f && "%" == d[T]; ++T);
                                for (var M = S && "!" == d[S - 1] || T < f && "1" == d[T] ? "1" : "N", A = S; A < T; ++A) d[A] = M;
                                S = T - 1
                            }
                        }
                        ...
                        for (var F = 0; F < f; ++F)
                            if (r.test(d[F])) {
                                ...
                                for (var I = "L" == (F ? d[F - 1] : c), B = I == ("L" == (O < f ? d[O] : c)) ? I ? "L" : "R" : c, R = F; R < O; ++R) d[R] = B;
                                F = O - 1
                            }
                        for (var z, P = [], H = 0; H < f;)
                            if (o.test(d[H])) {
                                ...
                                for (var U = W; U < H;)
                                    if (a.test(d[U])) {
                                        W < U && P.splice(j, 0, new s(1, W, U));
                                        var q = U;
                                        for (++U; U < H && a.test(d[U]); ++U);
                                        P.splice(j, 0, new s(2, q, U)), W = U
                                    } else ++U;
                                W < H && P.splice(j, 0, new s(1, W, H))
                            }
                ...
                function ve(e) {
                    ...
                    if (t)
                        for (var n = e.curOp.cursorActivityHandlers || (e.curOp.cursorActivityHandlers = []), r = 0; r < t.length; ++r) - 1 == _(n, t[r]) && n.push(t[r])
                }
                ...
                function je(e, t) {
                    z(t, We.hasOwnProperty(e) ? We[e] : We[e] = {})
                }
                ...
                function pt(e, t, n) {
                    ...
                    var o = function(e, t, n) {
                            for (var r, i, o = e.doc, a = n ? -1 : t - (e.doc.mode.innerMode ? 1e3 : 100), s = t; s > a; --s) {
                                ...
                                var l = Ve(o, s - 1),
                                    u = l.stateAfter;
                                if (u && (!n || s + (u instanceof ct ? u.lookAhead : 0) <= o.modeFrontier)) return s;
                ...
                ht.prototype.lookAhead = function(e) {
                    ...
                    return t instanceof ct ? new ht(e, Ue(e.mode, t.state), n, t.lookAhead) : new ht(e, Ue(e.mode, t), n)
                ...
                function xt(e, t, n, r) {
                    ...
                    for (r && (o = []);
                        (r || c.pos < t.ch) && !c.eol();) c.start = c.pos, i = vt(s, c, u.state), r && o.push(new yt(c, i, Ue(a.mode, u.state)));
                ...
                function Mt(e, t) {
                    ...
                    if (l)
                        for (var p = 0; p < l.length; ++p) {
                            var m = l[p];
                            if (null != m.to && (m.to += c), null == m.from) Lt(s, m.marker) || (m.from = c, u && (s || (s = [])).push(m));
                            else m.from += c, u && (s || (s = [])).push(m)
                        }
                    ...
                    if (!u) {
                        ...
                        if (y > 0 && s)
                            for (var x = 0; x < s.length; ++x) null == s[x].to && (v || (v = [])).push(new St(s[x].marker, null, null));
                ...
                function It(e, t) {
                    ...
                    if (r)
                        for (var i = void 0, o = 0; o < r.length; ++o)(i = r[o]).marker.collapsed && null == (t ? i.from : i.to) && (!n || Ot(n, i.marker) < 0) && (n = i.marker);
                    return n
                }
                ...
                function en(e, t, n, r, i, o, l) {
                    if (t) {
                        ...
                        if (e.trailingSpace = 32 == c.charCodeAt(t.length - 1), n || r || i || f || o) {
                            ...
                            var w = E("span", [u], b, o);
                            if (l)
                                for (var k in l) l.hasOwnProperty(k) && "style" != k && "class" != k && w.setAttribute(k, l[k]);
                ...
                function rn(e, t, n) {
                    var r = e.markedSpans,
                        ...
                        o = 0;
                    if (r)
                        for (var a, s, l, u, c, h, f, d = i.length, p = 0, m = 1, g = "", v = 0;;) {
                            if (v == p) {
                                ...
                                for (var y = [], x = void 0, b = 0; b < r.length; ++b) {
                                    ...
                                    if ("bookmark" == k.type && w.from == p && k.widgetNode) y.push(k);
                                        ...
                                        if (null != w.to && w.to != p && v > w.to && (v = w.to, u = ""), k.className && (l += " " + k.className), k.css && (s = (s ? s + ";" : "") + k.css), k.startStyle && w.from == p && (c += " " + k.startStyle), k.endStyle && w.to == v && (x || (x = [])).push(k.endStyle, w.to), k.title && ((f || (f = {})).title = k.title), k.attributes)
                                ...
                                if (!h || h.from == p)
                                    for (var L = 0; L < y.length; ++L) nn(t, 0, y[L]);
                                if (h && (h.from || 0) == p) {
                ...
                function on(e, t, n) {
                    this.line = t, this.rest = function(e) {
                        ...
                        return n
                    }(t), this.size = this.rest ? Ze(K(this.rest)) - n + 1 : 1, this.node = this.text = null, this.hidden = jt(e, t)
                }
                ...
                function gn(e, t, n, r) {
                    ...
                    if (e.options.lineNumbers || o) {
                        ...
                        if (e.display.input.setUneditable(s), a.insertBefore(s, t.text), t.line.gutterClass && (s.className += " " + t.line.gutterClass), !e.options.lineNumbers || o && o["CodeMirror-linenumbers"] || (t.lineNumber = s.appendChild(E("div", et(e.options, n), "CodeMirror-linenumber CodeMirror-gutter-elt", "left: " + r.gutterLeft["CodeMirror-linenumbers"] + "px; width: " + e.display.lineNumInnerWidth + "px"))), o)
                ...
                function bn(e, t, n, r, i) {
                    if (t.widgets)
                        for (var o = fn(n), a = 0, s = t.widgets; a < s.length; ++a) {
                            var l = s[a],
                                u = E("div", [l.node], "CodeMirror-linewidget");
                ...
                function On(e, t) {
                    var n = Ze(t),
                        r = Fn(e, n);
                    r && !r.text ? r = null : r && r.changes && (hn(e, r, n, ir(e)), e.curOp.forceUpdate = !0), r || (r = function(e, t) {
                        var n = Ze(t = Ht(t)),
                    ...
                    if (c) {
                        var h = (e.options.lineWrapping ? function(e, t, n, r, i, o, a) {
                            ...
                            for (var c = null, h = null, f = 0; f < i.length; f++) {
                                ...
                                if (!(d.from >= u || d.to <= l)) {
                                    var p = 1 != d.level,
                                        m = In(e, r, p ? Math.min(u, d.to) - 1 : Math.max(l, d.from)).right,
                                        g = m < o ? o - m + 1e9 : m - o;
                                    (!c || h > g) && (c = d, h = g)
                                }
                            }
                ...
                function nr(e) {
                    ...
                    if (null == Bn) {
                        ...
                        for (var t = 0; t < 49; ++t) Bn.appendChild(document.createTextNode("x")), Bn.appendChild(E("br"));
                ...
                function lr(e, t, n, r) {
                    ...
                    var l, u = Zn(e, o, a);
                    if (r && 1 == u.xRel && (l = Ve(e.doc, u.line).text).length == u.ch) {
                        var c = P(l, l.length, e.options.tabSize) - l.length;
                        u = tt(u.line, Math.max(0, Math.round((o - Tn(e.display).left) / rr(e.display)) - c))
                    }
                    return u
                }
                ...
                function cr(e, t, n, r) {
                    ...
                    var i = e.display;
                    if (r && n < i.viewTo && (null == i.updateLineNumbers || i.updateLineNumbers > t) && (i.updateLineNumbers = t), e.curOp.viewChanged = !0, t >= i.viewTo) Ct && _t(e.doc, t) < i.viewTo && fr(e);
                    else if (n <= i.viewFrom) Ct && Wt(e.doc, n + r) > i.viewFrom ? fr(e) : (i.viewFrom += r, i.viewTo += r);
                        ...
                        var s = dr(e, t, t, -1),
                            l = dr(e, n, n + r, 1);
                        s && l ? (i.view = i.view.slice(0, s.index).concat(an(e, s.lineN, l.lineN)).concat(i.view.slice(l.index)), i.viewTo += r) : fr(e)
                    }
                    ...
                    for (var n = e.doc, r = {}, i = r.cursors = document.createDocumentFragment(), o = r.selection = document.createDocumentFragment(), a = 0; a < n.sel.ranges.length; a++)
                        if (t || a != n.sel.primIndex) {
                            ...
                            if (!(s.from().line >= e.display.viewTo || s.to().line < e.display.viewFrom)) {
                                var l = s.empty();
                                (l || e.options.showCursorWhenSelecting) && vr(e, s.head, i), l || xr(e, s, o)
                            }
                        }
                    return r
                }
                ...
                function xr(e, t, n) {
                    ...
                    function h(t, n, r) {
                        ...
                        return function(e, t, n, r) {
                            ...
                            }(!o || yr(v, o) < 0) && (o = v), yr(y, o) < 0 && (o = y), (!a || yr(v, a) < 0) && (a = v), yr(y, a) < 0 && (a = y)
                        }), {
                            start: o,
                            end: a
                        }
                ...
                function Cr(e, t) {
                    ...
                    }, 20)), e.display.input.receivedFocus()), br(e))
                }
                ...
                function Lr(e) {
                    for (var t = e.display, n = t.lineDiv.offsetTop, r = 0; r < t.view.length; r++) {
                        ...
                        if (!i.hidden) {
                            ...
                            if ((f > .005 || f < -.005) && (Ye(i.line, l), Tr(i.line), i.rest))
                                for (var d = 0; d < i.rest.length; d++) Tr(i.rest[d]);
                            if (u > e.display.sizerWidth) {
                                var p = Math.ceil(u / rr(e.display));
                ...
                function Er(e, t) {
                    null != t && (Fr(e), e.curOp.scrollTop = (null == e.curOp.scrollTop ? e.doc.scrollTop : e.curOp.scrollTop) + t)
                }
                ...
                function Dr(e, t, n) {
                    null == t && null == n || Fr(e), null != t && (e.curOp.scrollLeft = t), null != n && (e.curOp.scrollTop = n)
                }
                ...
                function Ir(e, t) {
                    Math.abs(e.doc.scrollTop - t) < 2 || (n || ai(e, {
                        top: t
                    }), Br(e, t, !0), n && ai(e), ti(e, 100))
                }
                ...
                function Rr(e, t, n, r) {
                    t = Math.min(t, e.display.scroller.scrollWidth - e.display.scroller.clientWidth), (n ? t == e.doc.scrollLeft : Math.abs(e.doc.scrollLeft - t) < 2) && !r || (e.doc.scrollLeft = t, ui(e), e.display.scroller.scrollLeft != t && (e.display.scroller.scrollLeft = t), e.display.scrollbars.setScrollLeft(t))
                }
                ...
                function _r(e, t) {
                    ...
                    Wr(e, t);
                    for (var i = 0; i < 4 && n != e.display.barWidth || r != e.display.barHeight; i++) n != e.display.barWidth && e.options.lineWrapping && Lr(e), Wr(e, zr(e)), n = e.display.barWidth, r = e.display.barHeight
                }
                ...
                function Ur(e) {
                    e.display.scrollbars && (e.display.scrollbars.clear(), e.display.scrollbars.addClass && T(e.display.wrapper, e.display.scrollbars.addClass)), e.display.scrollbars = new jr[e.options.scrollbarStyle](function(t) {
                ...
                function Vr(e) {
                    ...
                    }(t), e.updateMaxLine && Gt(t), e.mustUpdate = e.viewChanged || e.forceUpdate || null != e.scrollTop || e.scrollToPos && (e.scrollToPos.from.line < n.viewFrom || e.scrollToPos.to.line >= n.viewTo) || n.maxLineChanged && t.options.lineWrapping, e.update = e.mustUpdate && new ri(t, e.mustUpdate && {
                        top: e.scrollTop,
                ...
                function Kr(e) {
                    ...
                    e.preparedSelection && t.display.input.showSelection(e.preparedSelection, n), (e.updatedDisplay || e.startHeight != t.doc.height) && _r(t, e.barMeasure), e.updatedDisplay && li(t, e.barMeasure), e.selectionChanged && br(t), t.state.focused && e.updateInput && t.display.input.reset(e.typing), n && wr(e.cm)
                }
                ...
                function Yr(e) {
                    var t = e.cm,
                        n = t.display,
                        r = t.doc;
                    (e.updatedDisplay && oi(t, e.update), null == n.wheelStartX || null == e.scrollTop && null == e.scrollLeft && !e.scrollToPos || (n.wheelStartX = n.wheelStartY = null), null != e.scrollTop && Br(t, e.scrollTop, e.forceScroll), null != e.scrollLeft && Rr(t, e.scrollLeft, !0, !0), e.scrollToPos) && function(e, t) {
                        ...
                        for (var o = 0; o < 5; o++) {
                            var a = !1,
                                ...
                                c = e.doc.scrollTop,
                                h = e.doc.scrollLeft;
                            if (null != u.scrollTop && (Ir(e, u.scrollTop), Math.abs(e.doc.scrollTop - c) > 1 && (a = !0)), null != u.scrollLeft && (Rr(e, u.scrollLeft), Math.abs(e.doc.scrollLeft - h) > 1 && (a = !0)), !a) break
                        }
                        return i
                    ...
                    if (o)
                        for (var s = 0; s < o.length; ++s) o[s].lines.length && me(o[s], "unhide");
                    ...
                    if (!(t.highlightFrontier >= e.display.viewTo)) {
                        ...
                        t.iter(r.line, Math.min(t.first + t.size, e.display.viewTo + 500), function(o) {
                            if (r.line >= e.display.viewFrom) {
                                ...
                                for (var h = !a || a.length != o.styles.length || u != c && (!u || !c || u.bgClass != c.bgClass || u.textClass != c.textClass), f = 0; !h && f < a.length; ++f) h = a[f] != o.styles[f];
                ...
                var ri = function(e, t, n) {
                    var r = e.display;
                    this.viewport = t, this.visible = Mr(r, e.doc, t), this.editorIsHidden = !r.wrapper.offsetWidth, this.wrapperHeight = r.wrapper.clientHeight, this.wrapperWidth = r.wrapper.clientWidth, this.oldDisplayWidth = An(e), this.force = n, this.dims = ir(e), this.events = []
                };
                ...
                function ii(e, t) {
                    ...
                    ci(e) && (fr(e), t.dims = ir(e));
                    var i = r.first + r.size,
                        o = Math.max(t.visible.from - e.options.viewportMargin, r.first),
                        a = Math.min(i, t.visible.to + e.options.viewportMargin);
                    n.viewFrom < o && o - n.viewFrom < 20 && (o = Math.max(r.first, n.viewFrom)), n.viewTo > a && n.viewTo - a < 20 && (a = Math.min(i, n.viewTo)), Ct && (o = _t(e.doc, o), a = Wt(e.doc, a));
                    var s = o != n.viewFrom || a != n.viewTo || n.lastWrapHeight != t.wrapperHeight || n.lastWrapWidth != t.wrapperWidth;
                    ! function(e, t, n) {
                        var r = e.display;
                        0 == r.view.length || t >= r.viewTo || n <= r.viewFrom ? (r.view = an(e, t, n), r.viewFrom = t) : (r.viewFrom > t ? r.view = an(e, t, r.viewFrom).concat(r.view) : r.viewFrom < t && (r.view = r.view.slice(ur(e, t))), r.viewFrom = t, r.viewTo < n ? r.view = r.view.concat(an(e, r.viewTo, n)) : r.viewTo > n && (r.view = r.view.slice(0, ur(e, n)))), r.viewTo = n
                    ...
                    return u > 4 && (n.lineDiv.style.display = "none"),
                        function(e, t, n) {
                            ...
                            for (var u = r.view, c = r.viewFrom, h = 0; h < u.length; h++) {
                                ...
                                if (f.hidden);
                                    ...
                                    f.changes && (_(f.changes, "gutter") > -1 && (d = !1), hn(e, f, c, n)), d && (M(f.lineNumber), f.lineNumber.appendChild(document.createTextNode(et(e.options, c)))), a = f.node.nextSibling
                                } else {
                                    var p = yn(e, f, c, n);
                                    o.insertBefore(p, a)
                                }
                        ...
                        }(c), M(n.cursorDiv), M(n.selectionDiv), n.gutters.style.height = n.sizer.style.minHeight = 0, s && (n.lastWrapHeight = t.wrapperHeight, n.lastWrapWidth = t.wrapperWidth, ti(e, 400)), n.updateLineNumbers = null, !0
                }

                function oi(e, t) {
                    for (var n = t.viewport, r = !0;
                        (r && e.options.lineWrapping && t.oldDisplayWidth != An(e) || (n && null != n.top && (n = {
                            top: Math.min(e.doc.height + Ln(e.display) - En(e), n.top)
                        }), t.visible = Mr(e.display, e.doc, n), !(t.visible.from >= e.display.viewFrom && t.visible.to <= e.display.viewTo))) && ii(e, t); r = !1) {
                        Lr(e);
                        var i = zr(e);
                        mr(e), _r(e, i), li(e, i), t.force = !1
                    }
                ...
                function ui(e) {
                    ...
                    if (t.alignWidgets || t.gutters.firstChild && e.options.fixedGutter) {
                        for (var r = or(t) - t.scroller.scrollLeft + e.doc.scrollLeft, i = t.gutters.offsetWidth, o = r + "px", a = 0; a < n.length; a++)
                            if (!n[a].hidden) {
                ...
                function xi(e, t) {
                    ...
                    if (i && u || o && c) {
                        ...
                        if (i && !n && !h && null != gi) return o && c && Ir(e, Math.max(0, s.scrollTop + o * gi)), Rr(e, Math.max(0, s.scrollLeft + i * gi)), (!o || o && c) && be(t), void(a.wheelStartX = null);
                        if (o && null != gi) {
                            var m = o * gi,
                                g = e.doc.scrollTop,
                        ...
                        mi < 20 && (null == a.wheelStartX ? (a.wheelStartX = s.scrollLeft, a.wheelStartY = s.scrollTop, a.wheelDX = i, a.wheelDY = o, setTimeout(function() {
                            if (null != a.wheelStartX) {
                                ...
                                a.wheelStartX = a.wheelStartY = null, n && (gi = (gi * mi + n) / (mi + 1), ++mi)
                            }
                        }, 200)) : (a.wheelDX += i, a.wheelDY += o))
                    }
                }
                a ? gi = -.53 : n ? gi = 15 : c ? gi = -.7 : f && (gi = -1 / 3);
                var bi = function(e, t) {
                ...
                bi.prototype.primary = function() {
                    ...
                    for (var e = [], t = 0; t < this.ranges.length; t++) e[t] = new wi(it(this.ranges[t].anchor), it(this.ranges[t].head));
                ...
                function ki(e, t, n) {
                    ...
                    for (var o = 1; o < t.length; o++) {
                        ...
                        if (r && !a.empty() ? l > 0 : l >= 0) {
                            ...
                            o <= n && --n, t.splice(--o, 2, new wi(h ? c : u, h ? u : c))
                        }
                    }
                    return new bi(t, n)
                }
                ...
                function Li(e, t) {
                    ...
                    if (nt(e, t.to) <= 0) return Si(t);
                    var n = e.line + t.text.length - (t.to.line - t.from.line) - 1,
                        r = e.ch;
                    return e.line == t.to.line && (r += Si(t).ch - t.to.ch), tt(n, r)
                }

                function Ti(e, t) {
                    for (var n = [], r = 0; r < e.sel.ranges.length; r++) {
                        var i = e.sel.ranges[r];
                        n.push(new wi(Li(i.anchor, t), Li(i.head, t)))
                    }
                ...
                function Ai(e) {
                    e.doc.mode = _e(e.options, e.doc.modeOption), Ei(e)
                }

                function Ei(e) {
                    e.doc.iter(function(e) {
                        e.stateAfter && (e.stateAfter = null), e.styles && (e.styles = null)
                    }), e.doc.modeFrontier = e.doc.highlightFrontier = e.doc.first, ti(e, 100), e.state.modeGen++, e.curOp && cr(e)
                }
                ...
                function Di(e, t, n, r) {
                    ...
                    function a(e, t) {
                        for (var n = [], o = e; o < t; ++o) n.push(new Vt(u[o], i(o), r));
                        return n
                    }
                    var s = t.from,
                        l = t.to,
                    ...
                    if (t.full) e.insert(0, a(0, u.length)), e.remove(u.length, e.size - u.length);
                        ...
                        if (1 == u.length) o(c, c.text.slice(0, s.ch) + f + c.text.slice(l.ch), d);
                        else {
                            var g = a(1, u.length - 1);
                            g.push(new Vt(f + c.text.slice(l.ch), d, r)), o(c, c.text.slice(0, s.ch) + u[0], i(0)), e.insert(s.line + 1, g)
                        }
                    else if (1 == u.length) o(c, c.text.slice(0, s.ch) + u[0] + h.text.slice(l.ch), i(0)), e.remove(s.line + 1, p);
                    else {
                ...
                function Oi(e, t) {
                    ...
                    e.doc = t, t.cm = e, sr(e), Ai(e), Ii(e), e.options.lineWrapping || Gt(e), e.options.mode = t.modeOption, cr(e)
                }
                ...
                function Ri(e, t) {
                    ...
                    return Wi(e, n, t.from.line, t.to.line + 1), Fi(e, function(e) {
                ...
                function Pi(e, t, n, r) {
                    ...
                    if ((i.lastOp == r || i.lastOrigin == t.origin && t.origin && ("+" == t.origin.charAt(0) && i.lastModTime > s - (e.cm ? e.cm.options.historyEventDelay : 500) || "*" == t.origin.charAt(0))) && (o = function(e, t) {
                            return t ? (zi(e.done), K(e.done)) : e.done.length && !K(e.done).ranges ? K(e.done) : e.done.length > 1 && !e.done[e.done.length - 2].ranges ? (e.done.pop(), K(e.done)) : void 0
                        }(i, i.lastOp == r))) a = K(o.changes), 0 == nt(t.from, t.to) && 0 == nt(t.from, a.to) ? a.to = Si(t) : o.changes.push(Ri(e, t));
                    else {
                        var l = K(i.done);
                        for (l && l.ranges || _i(e.sel, i.done), o = {
                                changes: [Ri(e, t)],
                ...
                function Hi(e, t, n, r) {
                    ...
                    }(e, o, K(i.done), t)) ? i.done[i.done.length - 1] = t : _i(t, i.done), i.lastSelTime = +new Date, i.lastSelOrigin = o, i.lastSelOp = n, r && !1 !== r.clearRedo && zi(i.undone)
                }
                ...
                function qi(e, t, n) {
                    for (var r = [], i = 0; i < e.length; ++i) {
                        var o = e[i];
                        if (o.ranges) r.push(n ? bi.prototype.deepCopy.call(o) : o);
                        else {
                            var a = o.changes,
                                s = [];
                            r.push({
                            ...
                            for (var l = 0; l < a.length; ++l) {
                                ...
                                if (s.push({
                                    ...
                                    for (var h in u)(c = h.match(/^spans_(\d+)$/)) && _(t, Number(c[1])) > -1 && (K(s)[h] = u[h], delete u[h])
                            }
                        }
                    }
                    return r
                ...
                function Gi(e, t, n, r, i) {
                    null == i && (i = e.cm && (e.cm.display.shift || e.extend)), Zi(e, new bi([$i(e.sel.primary(), t, n, i)], 0), r)
                }

                function Vi(e, t, n) {
                    for (var r = [], i = e.cm && (e.cm.display.shift || e.extend), o = 0; o < e.sel.ranges.length; o++) r[o] = $i(e.sel.ranges[o], t[o], null, i);
                    Zi(e, ki(e.cm, r, e.sel.primIndex), n)
                }

                function Xi(e, t, n, r) {
                    var i = e.sel.ranges.slice(0);
                    i[t] = n, Zi(e, ki(e.cm, i, e.sel.primIndex), r)
                }
                ...
                function Ji(e, t, n) {
                    (ye(e, "beforeSelectionChange") || e.cm && ye(e.cm, "beforeSelectionChange")) && (t = function(e, t, n) {
                        var r = {
                            ...
                            update: function(t) {
                                this.ranges = [];
                                for (var n = 0; n < t.length; n++) this.ranges[n] = new wi(lt(e, t[n].anchor), lt(e, t[n].head))
                            },
                            origin: n && n.origin
                        };
                        return me(e, "beforeSelectionChange", e, r), e.cm && me(e.cm, "beforeSelectionChange", e.cm, r), r.ranges != t.ranges ? ki(e.cm, r.ranges, r.ranges.length - 1) : t
                    }(e, t, n));
                    var r = n && n.bias || (nt(t.primary().head, e.sel.primary().head) < 0 ? -1 : 1);
                    Qi(e, to(e, t, r, !0)), n && !1 === n.scroll || !e.cm || Nr(e.cm)
                }
                ...
                function to(e, t, n, r) {
                    for (var i, o = 0; o < t.ranges.length; o++) {
                        var a = t.ranges[o],
                            ...
                            l = ro(e, a.anchor, s && s.anchor, n, r),
                            u = ro(e, a.head, s && s.head, n, r);
                        (i || l != a.anchor || u != a.head) && (i || (i = t.ranges.slice(0, o)), i[o] = new wi(l, u))
                    }
                            ...
                            if ((null == s.from || (u ? s.from <= t.ch : s.from < t.ch)) && (null == s.to || (c ? s.to >= t.ch : s.to > t.ch))) {
                                ...
                                if (n) {
                                    var h = l.find(r < 0 ? 1 : -1),
                                        f = void 0;
                                    if ((r < 0 ? c : u) && (h = io(e, h, -r, h && h.line == t.line ? o : null)), h && h.line == t.line && (f = nt(h, n)) && (r < 0 ? f < 0 : f > 0)) return no(e, h, t, r, i)
                                }
                                var d = l.find(r < 0 ? -1 : 1);
                                return (r < 0 ? u : c) && (d = io(e, d, r, d.line == t.line ? o : null)), d ? no(e, d, t, r, i) : null
                            }
                        }
                    return t
                }
                ...
                function ro(e, t, n, r, i) {
                    var o = r || 1,
                        a = no(e, t, n, o, i) || !i && no(e, t, n, o, !0) || no(e, t, n, -o, i) || !i && no(e, t, n, -o, !0);
                ...
                function so(e, t, n) {
                    ...
                    if (!(ye(e, "beforeChange") || e.cm && ye(e.cm, "beforeChange")) || (t = ao(e, t, !0))) {
                        ...
                        if (r)
                            for (var i = r.length - 1; i >= 0; --i) lo(e, {
                                from: r[i].from,
                                to: r[i].to,
                                text: i ? [""] : t.text,
                                origin: t.origin
                ...
                function lo(e, t) {
                    if (1 != t.text.length || "" != t.text[0] || 0 != nt(t.from, t.to)) {
                        var n = Ti(e, t);
                        Pi(e, t, n, e.cm ? e.cm.curOp.id : NaN), ho(e, t, n, Mt(e, t));
                        var r = [];
                        Fi(e, function(e, n) {
                            n || -1 != _(r, e.history) || (go(e.history, t), r.push(e.history)), ho(e, t, null, Mt(e, t))
                        })
                    }
                }
                    ...
                    if (!r || n) {
                        ...
                        if (u != s.length) {
                            for (o.lastOrigin = o.lastSelOrigin = null;;) {
                                ...
                                if (_i(i, l), n && !i.equals(e.sel)) return void Zi(e, i, {
                                    clearRedo: !1
                                });
                                a = i
                            }
                            ...
                            for (var h = ye(e, "beforeChange") || e.cm && ye(e.cm, "beforeChange"), f = function(n) {
                                    var r = i.changes[n];
                                    if (r.origin = t, h && !ao(e, r, !1)) return s.length = 0, {};
                                    c.push(Ri(e, r));
                                    var o = n ? Ti(e, r) : K(s);
                                    ho(e, r, o, Ui(e, r)), !n && e.cm && e.cm.scrollIntoView({
                                        from: r.from,
                                        to: Si(r)
                                    });
                                    var a = [];
                                    Fi(e, function(e, t) {
                                        t || -1 != _(a, e.history) || (go(e.history, r), a.push(e.history)), ho(e, r, null, Ui(e, r))
                                    })
                ...
                function co(e, t) {
                    if (0 != t && (e.first += t, e.sel = new bi(Y(e.sel.ranges, function(e) {
                            return new wi(tt(e.anchor.line + t, e.anchor.ch), tt(e.head.line + t, e.head.ch))
                ...
                function ho(e, t, n, r) {
                    if (e.cm && !e.cm.curOp) return Jr(e.cm, ho)(e, t, n, r);
                    if (t.to.line < e.first) co(e, t.text.length - 1 - (t.to.line - t.from.line));
                        ...
                        t.to.line > o && (t = {
                            ...
                            text: [t.text[0]],
                            origin: t.origin
                        }), t.removed = Xe(e, t.from, t.to), n || (n = Ti(e, t)), e.cm ? function(e, t, n) {
                            var r = e.doc,
                                i = e.display,
                                o = t.from,
                                a = t.to,
                            ...
                            Di(r, t, n, ar(e)), e.options.lineWrapping || (r.iter(l, o.line + t.text.length, function(e) {
                                var t = $t(e);
                            ...
                            t.full ? cr(e) : o.line != a.line || 1 != t.text.length || Ni(e.doc, t) ? cr(e, o.line, a.line + 1, u) : hr(e, o.line, "text");
                            var c = ye(e, "changes"),
                                h = ye(e, "change");
                            if (h || c) {
                                var f = {
                        ...
                        }(e.cm, t, r) : Di(e, t, r), Ji(e, n, U), e.cantEdit && ro(e, tt(e.firstLine(), 0)) && (e.cantEdit = !1)
                    }
                }

                function fo(e, t, n, r, i) {
                    var o;
                    r || (r = n), nt(r, n) < 0 && (n = (o = [r, n])[0], r = o[1]), "string" == typeof t && (t = e.splitLines(t)), so(e, {
                        from: n,
                        to: r,
                        text: t,
                        origin: i
                ...
                function mo(e, t, n, r) {
                    for (var i = 0; i < e.length; ++i) {
                        ...
                        if (o.ranges) {
                            ...
                            for (var s = 0; s < o.ranges.length; s++) po(o.ranges[s].anchor, t, n, r), po(o.ranges[s].head, t, n, r)
                        } else {
                ...
                function vo(e, t, n, r) {
                    var i = t,
                        o = t;
                    return "number" == typeof t ? o = Ve(e, st(e, t)) : i = Ze(t), null == i ? null : (r(o, i) && e.cm && hr(e.cm, i, n), o)
                }
                ...
                function wo(e, t, n) {
                    qt(t) < (e.curOp && e.curOp.scrollTop || e.doc.scrollTop) && Er(e, n)
                }
                bo.prototype.clear = function() {
                    ...
                    this.height = null;
                    var i = kn(this) - t;
                    i && (jt(this.doc, r) || Ye(r, r.height + i), n && Zr(n, function() {
                        n.curOp.forceUpdate = !0, wo(n, r, i), un(n, "lineWidgetChanged", n, e, Ze(r))
                    }))
                }, xe(bo);
                var ko = 0,
                    Co = function(e, t) {
                ...
                function So(e, t, n, r, i) {
                    if (r && r.shared) return function(e, t, n, r, i) {
                        ...
                        return Fi(e, function(e) {
                            s && (r.widgetNode = s.cloneNode(!0)), o.push(So(e, lt(e, t), lt(e, n), r, i));
                    ...
                    if (e.iter(l, n.line + 1, function(e) {
                            u && o.collapsed && !u.options.lineWrapping && Ht(e) == u.display.maxLine && (s = !0), o.collapsed && l != t.line && Ye(e, 0),
                                function(e, t) {
                            ...
                            return o.clear()
                        }), o.readOnly && (kt = !0, (e.history.done.length || e.history.undone.length) && e.clearHistory()), o.collapsed && (o.id = ++ko, o.atomic = !0), u) {
                        if (s && (u.curOp.updateMaxLine = !0), o.collapsed) cr(u, t.line, n.line + 1);
                        else if (o.className || o.startStyle || o.endStyle || o.css || o.attributes || o.title)
                            for (var c = t.line; c <= n.line; c++) hr(u, c, "text");
                        o.atomic && eo(u.doc), un(u, "markerAdded", u, o)
                    }
                    return o
                }
                Co.prototype.clear = function() {
                    if (!this.explicitlyCleared) {
                        ...
                        for (var r = null, i = null, o = 0; o < this.lines.length; ++o) {
                            ...
                            e && !this.collapsed ? hr(e, Ze(a), "text") : e && (null != s.to && (i = Ze(a)), null != s.from && (r = Ze(a))), a.markedSpans = Tt(a.markedSpans, s), null == s.from && this.collapsed && !jt(this.doc, a) && e && Ye(a, nr(e.display))
                        }
                        ...
                        null != r && e && this.collapsed && cr(e, r, i + 1), this.lines.length = 0, this.explicitlyCleared = !0, this.atomic && this.doc.cantEdit && (this.doc.cantEdit = !1, e && eo(e.doc)), e && un(e, "markerCleared", e, this, r, i), t && Gr(e), this.parent && this.parent.clear()
                    }
                    ...
                    t && r && Zr(r, function() {
                        var i = t.line,
                            o = Ze(t.line),
                            a = Fn(r, o);
                        if (a && (Hn(a), r.curOp.selectionChanged = r.curOp.forceUpdate = !0), r.curOp.updateMaxLine = !0, !jt(n.doc, i) && null != n.height) {
                            var s = n.height;
                            n.height = null;
                            var l = kn(n) - s;
                            l && Ye(i, i.height + l)
                ...
                function Mo(e) {
                    for (var t = function(t) {
                            var n = e[t],
                                r = [n.primary.doc];
                            Fi(n.primary.doc, function(e) {
                                return r.push(e)
                            });
                            for (var i = 0; i < n.markers.length; i++) {
                                var o = n.markers[i]; - 1 == _(r, o.doc) && (o.parent = null, n.markers.splice(i--, 1))
                            }
                ...
                var Ao = 0,
                    Eo = function(e, t, n, r, i) {
                        ...
                        null == n && (n = 0), xo.call(this, [new yo([new Vt("", null)])]), this.first = n, this.scrollTop = this.scrollLeft = 0, this.cantEdit = !1, this.cleanGeneration = 1, this.modeFrontier = this.highlightFrontier = n;
                        var o = tt(n, 0);
                        this.sel = Ci(o), this.history = new Bi(null), this.id = ++Ao, this.modeOption = t, this.lineSep = r, this.direction = "rtl" == i ? "rtl" : "ltr", this.extend = !1, "string" == typeof e && (e = this.splitLines(e)), Di(this, {
                            from: o,
                            to: o,
                            text: e
                        }), Zi(this, Ci(o), U)
                    };
                Eo.prototype = J(xo.prototype, {
                    constructor: Eo,
                    iter: function(e, t, n) {
                    ...
                    setValue: ei(function(e) {
                        ...
                        so(this, {
                            ...
                            origin: "setValue",
                            full: !0
                        }, !0), this.cm && Dr(this.cm, 0, 0), Zi(this, Ci(t), U)
                    }),
                    replaceRange: function(e, t, n, r) {
                        fo(this, e, t = lt(this, t), n = n ? lt(this, n) : t, r)
                    },
                    ...
                    setCursor: ei(function(e, t, n) {
                        Ki(this, lt(this, "number" == typeof e ? tt(e, t || 0) : e), null, n)
                    }),
                    setSelection: ei(function(e, t, n) {
                        Ki(this, lt(this, e), lt(this, t || e), n)
                    }),
                    extendSelection: ei(function(e, t, n) {
                    ...
                    extendSelectionsBy: ei(function(e, t) {
                        Vi(this, ut(this, Y(this.sel.ranges, e)), t)
                    }),
                    setSelections: ei(function(e, t, n) {
                        if (e.length) {
                            for (var r = [], i = 0; i < e.length; i++) r[i] = new wi(lt(this, e[i].anchor), lt(this, e[i].head));
                            null == t && (t = Math.min(e.length - 1, this.sel.primIndex)), Zi(this, ki(this.cm, r, t), n)
                        }
                    }),
                    addSelection: ei(function(e, t, n) {
                        var r = this.sel.ranges.slice(0);
                        r.push(new wi(lt(this, e), lt(this, t || e))), Zi(this, ki(this.cm, r, r.length - 1), n)
                    }),
                    ...
                    replaceSelections: ei(function(e, t, n) {
                        ...
                        for (var s = t && "end" != t && function(e, t, n) {
                                for (var r = [], i = tt(e.first, 0), o = i, a = 0; a < t.length; a++) {
                                    ...
                                    if (i = s.to, o = u, "around" == n) {
                                        ...
                                        r[a] = new wi(h ? u : l, h ? l : u)
                                    } else r[a] = new wi(l, l)
                                }
                                return new bi(r, e.sel.primIndex)
                            }(this, r, t), l = r.length - 1; l >= 0; l--) so(this, r[l]);
                        s ? Yi(this, s) : this.cm && Nr(this.cm)
                    }),
                    undo: ei(function() {
                        uo(this, "undo")
                    }),
                    ...
                    setGutterMarker: ei(function(e, t, n) {
                    ...
                    addLineClass: ei(function(e, t, n) {
                    ...
                    removeLineClass: ei(function(e, t, n) {
                        return vo(this, e, "gutter" == t ? "gutter" : "class", function(e) {
                            var r = "text" == t ? "textClass" : "background" == t ? "bgClass" : "gutter" == t ? "gutterClass" : "wrapClass",
                                i = e[r];
                            if (!i) return !1;
                    ...
                    addLineWidget: ei(function(e, t, n) {
                        return function(e, t, n, r) {
                            var i = new bo(e, n, r),
                                o = e.cm;
                            return o && i.noHScroll && (o.display.alignWidgets = !0), vo(e, t, "widget", function(t) {
                                ...
                                if (null == i.insertAt ? n.push(i) : n.splice(Math.min(n.length - 1, Math.max(0, i.insertAt)), 0, i), i.line = t, o && !jt(e, t)) {
                                    ...
                                    Ye(t, t.height + kn(i)), r && Er(o, i.height), o.curOp.forceUpdate = !0
                                }
                                return !0
                    ...
                    markText: function(e, t, n) {
                        return So(this, lt(this, e), lt(this, t), n, n && n.type || "range")
                    },
                    ...
                    copy: function(e) {
                        var t = new Eo(Ke(this, this.first, this.first + this.size), this.modeOption, this.first, this.lineSep, this.direction);
                    ...
                    linkedDoc: function(e) {
                        ...
                        var r = new Eo(Ke(this, t, n), e.mode || this.modeOption, t, this.lineSep, this.direction);
                            ...
                            function(e, t) {
                                for (var n = 0; n < t.length; n++) {
                                    var r = t[n],
                                        ...
                                        a = e.clipPos(i.to);
                                    if (nt(o, a)) {
                                        var s = So(e, o, a, r.primary, r.primary.type);
                    ...
                    unlinkDoc: function(e) {
                        if (e instanceof La && (e = e.doc), this.linked)
                            for (var t = 0; t < this.linked.length; ++t) {
                                if (this.linked[t].doc == e) {
                                    this.linked.splice(t, 1), e.unlinkDoc(this), Mo(To(this));
                                    break
                                }
                            }
                        if (e.history == this.history) {
                            ...
                            Fi(e, function(e) {
                                return n.push(e.id)
                            }, !0), e.history = new Bi(null), e.history.done = qi(this.history.done, n), e.history.undone = qi(this.history.undone, n)
                        }
                    },
                        ...
                        if (n && !t.isReadOnly())
                            if (r && r.length && window.FileReader && window.File)
                                ...
                                try {
                                    ...
                                    if (c) {
                                        var h;
                                        if (t.state.draggingText && !t.state.draggingText.copy && (h = t.listSelections()), Ji(t.doc, Ci(n, n)), h)
                                            for (var f = 0; f < h.length; ++f) fo(t.doc, "", h[f].anchor, h[f].head, "drag");
                ...
                for (var _o = 1; _o <= 12; _o++) zo[_o + 111] = zo[_o + 63235] = "F" + _o;
                var Wo = {};
                ...
                function Ko(e, t) {
                    ...
                    Zr(e, function() {
                        for (var t = r.length - 1; t >= 0; t--) fo(e.doc, "", r[t].from, r[t].to, "+delete");
                        Nr(e)
                    })
                }
                    ...
                    if (e) {
                        ...
                        if (o) {
                            ...
                            if (s.level > 0 || "rtl" == t.doc.direction) {
                                ...
                                }, i < 0 == (1 == s.level) ? s.from : s.to - 1, a), "before" == l && (a = Yo(n, a, 1))
                        ...
                        return Zr(e, function() {
                            for (var t = e.listSelections(), n = [], r = 0; r < t.length; r++)
                                if (t[r].empty()) {
                                    ...
                                    if (o)
                                        if (i.ch == o.length && (i = new tt(i.line, i.ch - 1)), i.ch > 0) i = new tt(i.line, i.ch + 1), e.replaceRange(o.charAt(i.ch - 1) + o.charAt(i.ch - 2), tt(i.line, i.ch - 2), i, "+transpose");
                ...
                function ea(e, t) {
                    var n = Ve(e.doc, t),
                        r = Ht(n);
                    return r != n && (t = Ze(r)), Jo(!0, e, r, t, 1)
                }
                ...
                function oa(e, t, n, r) {
                    ...
                    return "multi" == i && (e.state.keySeq = t), "handled" == i && un(e, "keyHandled", e, t, n), "handled" != i && "multi" != i || (be(n), br(e)), !!i
                }

                function aa(e, t) {
                    var n = Vo(t, !0);
                    return !!n && (t.shiftKey && !e.state.keySeq ? ia(e, "Shift-" + n, t, function(t) {
                        return na(e, t, !0)
                    }) || ia(e, n, t, function(t) {
                ...
                function la(e) {
                    ...
                    if (t.curOp.focus = F(), !ge(t, e)) {
                        ...
                        var r = aa(t, e);
                        h && (sa = r ? n : null, !r && 88 == n && !Ie && (y ? e.metaKey : e.ctrlKey) && t.replaceSelection("", null, "cut")), 18 != n || /\bCodeMirror-crosshair\b/.test(t.display.lineDiv.className) || function(e) {
                ...
                function ca(e) {
                    ...
                    if (!(Cn(t.display, e) || ge(t, e) || e.ctrlKey && !e.altKey || y && e.metaKey)) {
                        var n = e.keyCode,
                            r = e.charCode;
                        if (h && n == sa) return sa = null, void be(e);
                        if (!h || e.which && !(e.which < 10) || !aa(t, e)) {
                ...
                function pa(e) {
                    ...
                    if (!(ge(t, e) || n.activeTouch && n.input.supportsTouch()))
                        ...
                        var r = lr(t, e),
                            ...
                            o = r ? function(e, t) {
                                var n = +new Date;
                                return fa && fa.compare(n, e, t) ? (ha = fa = null, "triple") : ha && ha.compare(n, e, t) ? (fa = new da(n, e, t), ha = null, "double") : (ha = new da(n, e, t), fa = null, "single")
                            }(r, i) : "single";
                        window.focus(), 1 == i && t.state.selectingText && t.state.selectingText(e), r && function(e, t, n, r, i) {
                            ...
                            return ia(e, Go(o = (1 == t ? "Left" : 2 == t ? "Middle" : "Right") + o, i), i, function(t) {
                            ...
                            a ? setTimeout(R(wr, e), 0) : e.curOp.focus = F();
                            ...
                            e.options.dragDrop && Ae && !e.isReadOnly() && "single" == n && (i = u.contains(t)) > -1 && (nt((i = u.ranges[i]).from(), t) < 0 || t.xRel > 0) && (nt(i.to(), t) > 0 || t.xRel < 0) ? function(e, t, n, r) {
                                var i = e.display,
                                    o = !1,
                                    u = Jr(e, function(t) {
                                        l && (i.scroller.draggable = !1), e.state.draggingText = !1, pe(i.wrapper.ownerDocument, "mouseup", u), pe(i.wrapper.ownerDocument, "mousemove", c), pe(i.scroller, "dragstart", h), pe(i.scroller, "drop", u), o || (be(t), r.addNew || Gi(e.doc, n, null, null, r.extend), l || a && 9 == s ? setTimeout(function() {
                                ...
                                fe(i.wrapper.ownerDocument, "mouseup", u), fe(i.wrapper.ownerDocument, "mousemove", c), fe(i.scroller, "dragstart", h), fe(i.scroller, "drop", u), kr(e), setTimeout(function() {
                                ...
                                var a, s, l = o.sel,
                                    u = l.ranges;
                                r.addNew && !r.extend ? (s = o.sel.contains(n), a = s > -1 ? u[s] : new wi(n, n)) : (a = o.sel.primary(), s = o.sel.primIndex);
                                if ("rectangle" == r.unit) r.addNew || (a = new wi(n, n)), n = lr(e, t, !0, !0), s = -1;
                                else {
                                    var c = ma(e, n, r.unit);
                                    a = r.extend ? $i(a, c.anchor, c.head, r.extend) : c
                                }
                                r.addNew ? -1 == s ? (s = u.length, Zi(o, ki(e, u.concat([a]), s), {
                                    scroll: !1,
                                    origin: "*mouse"
                                })) : u.length > 1 && u[s].empty() && "char" == r.unit && !r.extend ? (Zi(o, ki(e, u.slice(0, s).concat(u.slice(s + 1)), 0), {
                                    scroll: !1,
                                    origin: "*mouse"
                                }), l = o.sel) : Xi(o, s, a, q) : (s = 0, Zi(o, new bi([a], 0), q), l = o.sel);
                                var h = n;
                                    ...
                                    if (0 != nt(h, t))
                                        if (h = t, "rectangle" == r.unit) {
                                            for (var i = [], u = e.options.tabSize, c = P(Ve(o, n.line).text, n.ch, u), f = P(Ve(o, t.line).text, t.ch, u), d = Math.min(c, f), p = Math.max(c, f), m = Math.min(n.line, t.line), g = Math.min(e.lastLine(), Math.max(n.line, t.line)); m <= g; m++) {
                                                var v = Ve(o, m).text,
                                                    y = G(v, d, u);
                                                d == p ? i.push(new wi(tt(m, y), tt(m, y))) : v.length > y && i.push(new wi(tt(m, y), tt(m, G(v, p, u))))
                                            }
                                            i.length || i.push(new wi(n, n)), Zi(o, ki(e, l.ranges.slice(0, s).concat(i), s), {
                                                origin: "*mouse",
                                                scroll: !1
                                            }), e.scrollIntoView(t)
                                        } else {
                                            ...
                                            C[s] = function(e, t) {
                                                ...
                                                var f = o[u + (l ? -1 : 0)],
                                                    ...
                                                    p = d ? f.from : f.to,
                                                    m = d ? "after" : "before";
                                                return n.ch == p && n.sticky == m ? t : new wi(new tt(n.line, p, m), r)
                                            }(e, new wi(lt(o, k), x)), Zi(o, ki(e, C, s), q)
                                        }
                                }
                                ...
                                var g = Jr(e, function(t) {
                                        0 !== t.buttons && Le(t) ? function t(n) {
                                            var a = ++p;
                                            var s = lr(e, n, !0, "rectangle" == r.unit);
                                            if (!s) return;
                                            if (0 != nt(s, h)) {
                                                e.curOp.focus = F(), f(s);
                                                var l = Mr(i, o);
                        ...
                        }(t, r, o, e) : Se(e) == n.scroller && be(e) : 2 == i ? (r && Gi(t.doc, r), setTimeout(function() {
                            return n.input.focus()
                        }, 20)) : 3 == i && (C ? t.display.input.onContextMenu(e) : kr(t)))
                    }
                }
                ...
                function ma(e, t, n) {
                    ...
                    if ("line" == n) return new wi(tt(t.line, 0), lt(e.doc, tt(t.line + 1, 0)));
                    var r = n(e, t);
                ...
                function ya(e, t) {
                    Cn(e.display, t) || function(e, t) {
                        ...
                        return ga(e, t, "gutterContextMenu", !1)
                ...
                function Sa(e) {
                    e.options.lineWrapping ? (O(e.display.wrapper, "CodeMirror-wrap"), e.display.sizer.style.minWidth = "", e.display.sizerWidth = null) : (T(e.display.wrapper, "CodeMirror-wrap"), Gt(e)), sr(e), cr(e), Wn(e), setTimeout(function() {
                        return _r(e)
                    }, 100)
                }
                ...
                function La(e, t) {
                    ...
                    var i = new La.inputStyles[t.inputStyle](this),
                        o = this.display = new pi(e, r, i, t);
                    for (var u in o.wrapper.CodeMirror = this, xa(this), t.lineWrapping && (this.display.wrapper.className += " CodeMirror-wrap"), Ur(this), this.state = {
                                keyMaps: [],
                                overlays: [],
                                modeGen: 0,
                                overwrite: !1,
                            ...
                            function(e) {
                                var t = e.display;
                                fe(t.scroller, "mousedown", Jr(e, pa)), fe(t.scroller, "dblclick", a && s < 11 ? Jr(e, function(t) {
                                    if (!ge(e, t)) {
                                        var n = lr(e, t);
                                ...
                                fe(t.scroller, "touchstart", function(i) {
                                    ...
                                    if (r && !Cn(t, n) && null != r.left && !r.moved && new Date - r.start < 300) {
                                        ...
                                        a = !r.prev || o(r, r.prev) ? new wi(s, s) : !r.prev.prev || o(r, r.prev.prev) ? e.findWordAt(s) : new wi(tt(s.line, 0), lt(e.doc, tt(s.line + 1, 0))), e.setSelection(a.anchor, a.head), e.focus(), be(n)
                                    }
                                    i()
                                }), fe(t.scroller, "touchcancel", i), fe(t.scroller, "scroll", function() {
                                    t.scroller.clientHeight && (Ir(e, t.scroller.scrollTop), Rr(e, t.scroller.scrollLeft, !0), me(e, "scroll", e))
                                    ...
                                    over: function(t) {
                                        ge(e, t) || (! function(e, t) {
                                            ...
                                            if (n) {
                                                ...
                                                vr(e, n, r), e.display.dragCursor || (e.display.dragCursor = E("div", null, "CodeMirror-cursors CodeMirror-dragcursors"), e.display.lineSpace.insertBefore(e.display.dragCursor, e.display.cursorDiv)), A(e.display.dragCursor, r)
                                            }
                                        }(e, t), Ce(t))
                                    },
                                    start: function(t) {
                                        return function(e, t) {
                                            if (a && (!e.state.draggingText || +new Date - No < 100)) Ce(t);
                                            else if (!ge(e, t) && !Cn(e.display, t) && (t.dataTransfer.setData("Text", e.getSelection()), t.dataTransfer.effectAllowed = "copyMove", t.dataTransfer.setDragImage && !f)) {
                                ...
                                fe(l, "keyup", function(t) {
                                    return ua.call(e, t)
                                }), fe(l, "keydown", Jr(e, la)), fe(l, "keypress", Jr(e, ca)), fe(l, "focus", function(t) {
                                    return Cr(e, t)
                                }), fe(l, "blur", function(t) {
                                    return Sr(e, t)
                                })
                            }(this), Bo(), $r(this), this.curOp.forceUpdate = !0, Oi(this, r), t.autofocus && !v || this.hasFocus() ? setTimeout(R(Cr, this), 20) : Sr(this), ka) ka.hasOwnProperty(u) && ka[u](n, t[u], ba);
                    ci(this), t.finishInit && t.finishInit(this);
                    for (var c = 0; c < Ta.length; ++c) Ta[c](n);
                    Gr(this), l && t.lineWrapping && "optimizelegibility" == getComputedStyle(o.lineDiv).textRendering && (o.lineDiv.style.textRendering = "auto")
                }
                La.defaults = wa, La.optionHandlers = ka;
                var Ta = [];
                ...
                function Ma(e, t, n, r) {
                    ...
                    if (r || /\S/.test(s.text)) {
                        if ("smart" == n && ((u = o.mode.indent(i, s.text.slice(c.length), s.text)) == j || u > 150)) {
                            if (!r) return;
                            n = "prev"
                        }
                    } else u = 0, n = "not";
                    ...
                    if (f < u && (h += X(u - f)), h != c) return fo(o, h, tt(t, 0), tt(t, c.length), "+input"), s.stateAfter = null, !0;
                ...
                function Na(e, t, n, r, i) {
                    ...
                    if (s && r.ranges.length > 1)
                        if (Aa && Aa.text.join("\n") == t) {
                            if (r.ranges.length % Aa.text.length == 0) {
                                u = [];
                                for (var c = 0; c < Aa.text.length; c++) u.push(o.splitLines(Aa.text[c]))
                            }
                    ...
                    for (var h = e.curOp.updateInput, f = r.ranges.length - 1; f >= 0; f--) {
                        var d = r.ranges[f],
                            p = d.from(),
                            m = d.to();
                        d.empty() && (n && n > 0 ? p = tt(p.line, p.ch - n) : e.state.overwrite && !s ? m = tt(m.line, Math.min(Ve(o, m.line).text.length, m.ch + K(l).length)) : s && Aa && Aa.lineWise && Aa.text.join("\n") == t && (p = m = tt(p.line, 0)));
                        var g = {
                            from: p,
                            to: m,
                        ...
                        so(e.doc, g), un(e, "inputRead", e, g)
                    }
                    t && !s && Fa(e, t), Nr(e), e.curOp.updateInput < 2 && (e.curOp.updateInput = h), e.curOp.typing = !0, e.state.pasteIncoming = e.state.cutIncoming = -1
                }
                    ...
                    if (e.options.electricChars && e.options.smartIndent)
                        for (var n = e.doc.sel, r = n.ranges.length - 1; r >= 0; r--) {
                            ...
                            if (!(i.head.ch > 100 || r && n.ranges[r - 1].head.line == i.head.line)) {
                                ...
                                } else o.electricInput && o.electricInput.test(Ve(e.doc, i.head.line).text.slice(0, i.head.ch)) && (a = Ma(e, i.head.line, "smart"));
                ...
                function Ba() {
                    ...
                    return l ? e.style.width = "1000px" : e.setAttribute("wrap", "off"), m && (e.style.border = "1px solid black"), Ia(e), t
                }
                ...
                function Ra(e, t, n, r, i) {
                    ...
                    function l(r) {
                        ...
                        if (null == (o = i ? function(e, t, n, r) {
                                ...
                                var s, l = function(e, n) {
                                        return Yo(t, e instanceof tt ? e.ch : e, n)
                                    },
                                    u = function(n) {
                    ...
                    if ("char" == r) l();
                        ...
                        for (var u = null, c = "group" == r, h = e.cm && e.cm.getHelper(t, "wordChars"), f = !0; !(n < 0) || l(!f); f = !1) {
                ...
                function Wa(e, t, n) {
                    ...
                    if (t == e.display.lineDiv) {
                        if (!(r = e.display.lineDiv.childNodes[n])) return _a(e.clipPos(tt(e.display.viewTo - 1)), !0);
                        t = null, n = 0
                    } else
                ...
                function ja(e, t, n) {
                    var r = e.text.firstChild,
                        i = !1;
                    if (!t || !D(r, t)) return _a(tt(Ze(e.line), 0), !0);
                    if (t == r && (i = !0, t = r.childNodes[n], n = 0, !t)) {
                        var o = e.rest ? K(e.rest) : e.line;
                        return _a(tt(Ze(o), o.text.length), i)
                    }
                    ...
                    for (var f = s.nextSibling, d = a ? a.nodeValue.length - n : 0; f; f = f.nextSibling) {
                        if (h = c(f, f.firstChild, 0)) return _a(tt(h.line, h.ch - d), i);
                        d += f.textContent.length
                    }
                    for (var p = s.previousSibling, m = n; p; p = p.previousSibling) {
                        if (h = c(p, p.firstChild, -1)) return _a(tt(h.line, h.ch + m), i);
                ...
                Pa.prototype.init = function(e) {
                    ...
                    Ia(i, r.options.spellcheck, r.options.autocorrect, r.options.autocapitalize), fe(i, "paste", function(e) {
                        ge(r, e) || Da(e, r) || s <= 11 && setTimeout(Jr(r, function() {
                    ...
                    if (t.display.viewTo == t.display.viewFrom || i.line >= t.display.viewTo || o.line < t.display.viewFrom) e.removeAllRanges();
                        ...
                        if (!a || a.bad || !s || s.bad || 0 != nt(at(a, s), i) || 0 != nt(ot(a, s), o)) {
                            var l = t.display.view,
                                u = i.line >= t.display.viewFrom && Ha(t, i) || {
                                    node: l[0].measure.map[2],
                                    offset: 0
                                },
                                c = o.line < t.display.viewTo && Ha(t, o);
                            if (!c) {
                    ...
                    if (null == this.readDOMTimeout && !this.gracePeriod && this.selectionChanged()) {
                        ...
                        if (!this.composing) {
                            ...
                            n && r && Zr(t, function() {
                                Zi(t.doc, Ci(n, r), U), (n.bad || r.bad) && (t.curOp.selectionChanged = !0)
                            })
                        }
                    }
                    ...
                    for (var h = r.doc.splitLines(function(e, t, n, r, i) {
                        ...
                        if (K(h) == K(f)) h.pop(), f.pop(), l--;
                        else {
                            if (h[0] != f[0]) break;
                            h.shift(), f.shift(), t++
                        }
                    for (var d = 0, p = 0, m = h[0], g = f[0], v = Math.min(m.length, g.length); d < v && m.charCodeAt(d) == g.charCodeAt(d);) ++d;
                    for (var y = K(h), x = K(f), b = Math.min(y.length - (1 == h.length ? d : 0), x.length - (1 == f.length ? d : 0)); p < b && y.charCodeAt(y.length - p - 1) == x.charCodeAt(x.length - p - 1);) ++p;
                    ...
                    return h.length > 1 || h[0] || nt(w, k) ? (fo(r.doc, h, w, k, "+input"), !0) : void 0
                    ...
                    0 == e.charCode || this.composing || (e.preventDefault(), this.cm.isReadOnly() || Jr(this.cm, Na)(this.cm, String.fromCharCode(null == e.charCode ? e.keyCode : e.charCode), 0))
                ...
                Ua.prototype.init = function(e) {
                        ...
                        e.wrapper.insertBefore(this.wrapper, e.wrapper.firstChild), m && (i.style.width = "0px"), fe(i, "input", function() {
                            ...
                            ge(r, e) || Da(e, r) || (r.state.pasteIncoming = +new Date, n.fastPoll())
                        ...
                        if (o && !h) {
                            n.options.resetSelectionOnContextMenu && -1 == n.doc.sel.contains(o) && Jr(n, Zi)(n.doc, Ci(o), U);
                        ...
                        function v() {
                            if (t.contextMenuPending == v && (t.contextMenuPending = !1, t.wrapper.style.cssText = d, i.style.cssText = f, a && s < 9 && r.scrollbars.setScrollTop(r.scroller.scrollTop = u), null != i.selectionStart)) {
                                ...
                                var e = 0,
                                    o = function() {
                                        r.selForContextMenu == n.doc.sel && 0 == i.selectionStart && i.selectionEnd > 0 && "​" == t.prevInput ? Jr(n, oo)(n) : e++ < 10 ? r.detectingSelectAll = setTimeout(o, 500) : (r.selForContextMenu = null, r.input.reset())
                                    };
                    ...
                    function(e) {
                        ...
                        e.defineOption = n, e.Init = ba, n("value", "", function(e, t) {
                            return e.setValue(t)
                            ...
                            if (e.doc.lineSep = t, t) {
                                ...
                                for (var i = n.length - 1; i >= 0; i--) fo(e.doc, t, n[i], tt(n[i].line, n[i].ch + t.length))
                            }
                        }), n("specialChars", /[\u0000-\u001f\u007f-\u009f\u00ad\u061c\u200b-\u200f\u2028\u2029\ufeff\ufff9-\ufffc]/g, function(e, t, n) {
                            e.state.specialChars = new RegExp(t.source + (t.test("\t") ? "" : "|\t"), "g"), n != ba && e.refresh()
                        ...
                        }), n("extraKeys", null), n("configureMouse", null), n("lineWrapping", !1, Sa, !0), n("gutters", [], function(e, t) {
                            e.display.gutterSpecs = hi(t, e.options.lineNumbers), di(e)
                            ...
                            Ur(e), _r(e), e.display.scrollbars.setScrollTop(e.doc.scrollTop), e.display.scrollbars.setScrollLeft(e.doc.scrollLeft)
                        }, !0), n("lineNumbers", !1, function(e, t) {
                            e.display.gutterSpecs = hi(e.options.gutters, t), di(e)
                        }, !0), n("firstLineNumber", 1, di, !0), n("lineNumberFormatter", function(e) {
                            return e
                        }, di, !0), n("showCursorWhenSelecting", !1, mr, !0), n("resetSelectionOnContextMenu", !0), n("lineWiseCopyCut", !0), n("pasteLinesPerSelection", !0), n("selectionsMayTouch", !1), n("readOnly", !1, function(e, t) {
                            "nocursor" == t && (Sr(e), e.display.input.blur()), e.display.input.readOnlyChanged(t)
                        }), n("disableInput", !1, function(e, t) {
                            t || e.display.input.reset()
                        }, !0), n("dragDrop", !0, Ca), n("allowDropFileTypes", null), n("cursorBlinkRate", 530), n("cursorScrollMargin", 0), n("cursorHeight", 1, mr, !0), n("singleCursorHeightPerLine", !0, mr, !0), n("workTime", 100), n("workDelay", 100), n("flattenSpans", !0, Ei, !0), n("addModeClass", !1, Ei, !0), n("pollInterval", 100), n("undoDepth", 200, function(e, t) {
                            return e.doc.history.undoDepth = t
                        }), n("historyEventDelay", 1250), n("viewportMargin", 10, function(e) {
                            return e.refresh()
                        }, !0), n("maxHighlightLength", 1e4, Ei, !0), n("moveInputWithCursor", !0, function(e, t) {
                    ...
                    function(e) {
                        ...
                        e.prototype = {
                            ...
                            setOption: function(e, n) {
                                var r = this.options,
                                    i = r[e];
                                r[e] == n && "mode" != e || (r[e] = n, t.hasOwnProperty(e) && Jr(this, t[e])(this, n, i), me(this, "optionChange", this, e))
                            },
                            ...
                            indentLine: Qr(function(e, t, n) {
                                "string" != typeof t && "number" != typeof t && (t = null == t ? this.options.smartIndent ? "smart" : "prev" : t ? "add" : "subtract"), Qe(this.doc, e) && Ma(this, e, t, n)
                            }),
                            indentSelection: Qr(function(e) {
                                for (var t = this.doc.sel.ranges, n = -1, r = 0; r < t.length; r++) {
                                    var i = t[r];
                                    if (i.empty()) i.head.line > n && (Ma(this, i.head.line, e, !0), n = i.head.line, r == this.doc.sel.primIndex && Nr(this));
                                    else {
                                        var o = i.from(),
                                            a = i.to(),
                                            s = Math.max(n, o.line);
                                        n = Math.min(this.lastLine(), a.line - (a.ch ? 0 : 1)) + 1;
                                        for (var l = s; l < n; ++l) Ma(this, l, e);
                                        var u = this.doc.sel.ranges;
                                        0 == o.ch && t.length == u.length && u[r].from().ch > 0 && Xi(this.doc, r, new wi(o, u[r].to()), U)
                                    }
                                }
                            }),
                            ...
                            getTokenTypeAt: function(e) {
                                e = lt(this.doc, e);
                                var t, n = dt(this, Ve(this.doc, e.line)),
                                    r = 0,
                                    i = (n.length - 1) / 2,
                                    o = e.ch;
                                if (0 == o) t = n[2];
                            ...
                            cursorCoords: function(e, t) {
                                ...
                                return Xn(this, null == e ? n.head : "object" == typeof e ? lt(this.doc, e) : e ? n.from() : n.to(), t || "page")
                            },
                            ...
                            addWidget: function(e, t, n, r, i) {
                                var o, a, s, l = this.display,
                                    ...
                                    c = e.left;
                                if (t.style.position = "absolute", t.setAttribute("cm-ignore-events", "true"), this.display.input.setUneditable(t), l.sizer.appendChild(t), "over" == r) u = e.top;
                                ...
                                }, null != (s = Ar(o, a)).scrollTop && Ir(o, s.scrollTop), null != s.scrollLeft && Rr(o, s.scrollLeft))
                            },
                            triggerOnKeyDown: Qr(la),
                            triggerOnKeyPress: Qr(ca),
                            triggerOnKeyUp: ua,
                            triggerOnMouseDown: Qr(pa),
                            ...
                            findWordAt: function(e) {
                                ...
                                return new wi(tt(e.line, n), tt(e.line, r))
                            },
                            toggleOverwrite: function(e) {
                            ...
                            refresh: Qr(function() {
                                ...
                                cr(this), this.curOp.forceUpdate = !0, Wn(this), Dr(this, this.doc.scrollLeft, this.doc.scrollTop), si(this.display), (null == e || Math.abs(e - nr(this.display)) > .5) && sr(this), me(this, "refresh", this)
                            }),
                            swapDoc: Qr(function(e) {
                                var t = this.doc;
                                return t.cm = null, this.state.selectingText && this.state.selectingText(), Oi(this, e), Wn(this), this.display.input.reset(), Dr(this, e.scrollLeft, e.scrollTop), this.curOp.forceScroll = !0, un(this, "swapDoc", this, t), t
                            }),
                            phrase: function(e) {
                ...
                for (var $a in Eo.prototype) Eo.prototype.hasOwnProperty($a) && _(qa, $a) < 0 && (La.prototype[$a] = function(e) {
                    return function() {
                        return e.apply(this.doc, arguments)
                    }
                }(Eo.prototype[$a]));
                return xe(Eo), La.inputStyles = {
                        textarea: Ua,
                        contenteditable: Pa
                    }, La.defineMode = function(e) {
                        La.defaults.mode || "null" == e || (La.defaults.mode = e), Pe.apply(this, arguments)
        ...
        13: [function(e, t, n) {
            ...
            r = function(e) {
                ...
                e.defineMode("markdown", function(t, n) {
                    ...
                    function x(r, i) {
                        var a, f = r.column() === i.indentation,
                        ...
                        if (null === i.indentationDiff && (i.indentationDiff = i.indentation, x)) {
                            for (i.em = !1, i.strong = !1, i.code = !1, i.strikethrough = !1, i.list = null; C < i.listStack[i.listStack.length - 1];) i.listStack.pop(), i.listStack.length ? i.indentation = i.listStack[i.listStack.length - 1] : i.list = !1;
                        ...
                        if (!L && !i.setext && f && i.indentation <= b && (T = r.match(l))) {
                            var M = T[1] ? "ol" : "ul";
                            return i.indentation = C + r.current().length, i.list = !0, i.quote = 0, i.listStack.push(i.indentation), n.taskLists && r.match(u, !1) && (i.taskList = !0), i.f = i.inline, n.highlightFormatting && (i.formatting = ["list", "list-" + M]), k(i)
                        }
                    ...
                    function S(t, i) {
                        ...
                        if ("*" === s || "_" === s) {
                            for (var w = 1, C = 1 == t.pos ? " " : t.string.charAt(t.pos - 2); w < 3 && t.eat(s);) w++;
                            var M = t.peek() || " ",
                                A = !/\s/.test(M) && (!m.test(M) || /\s/.test(C) || m.test(C)),
                                E = !/\s/.test(C) && (!m.test(C) || /\s/.test(M) || m.test(M)),
                                N = null,
                                D = null;
                            if (w % 2 && (i.em || !A || "*" !== s && E && !m.test(C) ? i.em != s || !E || "*" !== s && A && !m.test(M) || (N = !1) : N = !0), w > 1 && (i.strong || !A || "*" !== s && E && !m.test(C) ? i.strong != s || !E || "*" !== s && A && !m.test(M) || (D = !1) : D = !0), null != D || null != N) {
                                n.highlightFormatting && (i.formatting = null == N ? "strong" : null == D ? "em" : "strong em"), !0 === N && (i.em = s), !0 === D && (i.strong = s);
                                d = k(i);
                                return !1 === N && (i.em = !1), !1 === D && (i.strong = !1), d
                            }
        ...
        15: [function(e, t, n) {
            (function(e) {
                ...
                e.defineMode("xml", function(r, i) {
                    ...
                    function y(e, t, n) {
                        return "word" == e ? (n.tagName = t.current(), a = "tag", k) : l.allowMissingTagName && "endTag" == e ? (a = "tag bracket", k(e, t, n)) : (a = "error", y)
                    }
                    ...
                    function x(e, t, n) {
                        ...
                        return l.allowMissingTagName && "endTag" == e ? (a = "tag bracket", b(e, t, n)) : (a = "error", w)
                    }
            ...
            (function(e) {
                ! function(e) {
                    ...
                    r._label = /(?!\s*\])(?:\\[\[\]]|[^\[\]])+/, r._title = /(?:"(?:\\"?|[^"\\])*"|'[^'\n]*(?:\n[^'\n]+)*\n?'|\([^()]*\))/, r.def = d(r.def).replace("label", r._label).replace("title", r._title).getRegex(), r.bullet = /(?:[*+-]|\d{1,9}\.)/, r.item = /^( *)(bull) ?[^\n]*(?:\n(?!\1bull ?)[^\n]*)*/, r.item = d(r.item, "gm").replace(/bull/g, r.bullet).getRegex(), r.list = d(r.list).replace(/bull/g, r.bullet).replace("hr", "\\n+(?=\\1?(?:(?:- *){3,}|(?:_ *){3,}|(?:\\* *){3,})(?:\\n+|$))").replace("def", "\\n+(?=" + r.def.source + ")").getRegex(), r._tag = "address|article|aside|base|basefont|blockquote|body|caption|center|col|colgroup|dd|details|dialog|dir|div|dl|dt|fieldset|figcaption|figure|footer|form|frame|frameset|h[1-6]|head|header|hr|html|iframe|legend|li|link|main|menu|menuitem|meta|nav|noframes|ol|optgroup|option|p|param|section|source|summary|table|tbody|td|tfoot|th|thead|title|tr|track|ul", r._comment = /<!--(?!-?>)[\s\S]*?-->/, r.html = d(r.html, "i").replace("comment", r._comment).replace("tag", r._tag).replace("attribute", / +[a-zA-Z:_][\w.:-]*(?: *= *"[^"\n]*"| *= *'[^'\n]*'| *= *[^\s"'=<>`]+)?/).getRegex(), r.paragraph = d(r._paragraph).replace("hr", r.hr).replace("heading", " {0,3}#{1,6} +").replace("|lheading", "").replace("blockquote", " {0,3}>").replace("fences", " {0,3}(?:`{3,}|~{3,})[^`\\n]*\\n").replace("list", " {0,3}(?:[*+-]|1[.)]) ").replace("html", "</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|!--)").replace("tag", r._tag).getRegex(), r.blockquote = d(r.blockquote).replace("paragraph", r.paragraph).getRegex(), r.normal = y({}, r), r.gfm = y({}, r.normal, {
                        ...
                        var n, i, o, a, s, l, u, c, f, d, p, m, g, v, y, w;
                        for (e = e.replace(/^ +$/gm, ""); e;)
                            if ((o = this.rules.newline.exec(e)) && (e = e.substring(o[0].length), o[0].length > 1 && this.tokens.push({
                                ...
                                e = e.substring(o[0].length), k && "paragraph" === k.type ? k.text += "\n" + o[0].trimRight() : (o = o[0].replace(/^ {4}/gm, ""), this.tokens.push({
                                    type: "code",
                        ...
                        else if ((o = this.rules.nptable.exec(e)) && (l = {
                                type: "table",
                                header: x(o[1].replace(/^ *| *\| *$/g, "")),
                                align: o[2].replace(/^ *|\| *$/g, "").split(/ *\| */),
                                cells: o[3] ? o[3].replace(/\n$/, "").split("\n") : []
                            }).header.length === l.align.length) {
                            for (e = e.substring(o[0].length), p = 0; p < l.align.length; p++) /^ *-+: *$/.test(l.align[p]) ? l.align[p] = "right" : /^ *:-+: *$/.test(l.align[p]) ? l.align[p] = "center" : /^ *:-+ *$/.test(l.align[p]) ? l.align[p] = "left" : l.align[p] = null;
                            ...
                            for (e = e.substring(o[0].length), u = {
                                    ...
                                    start: v ? +a : "",
                                    loose: !1
                                }, this.tokens.push(u), c = [], n = !1, g = (o = o[0].match(this.rules.item)).length, p = 0; p < g; p++) d = (l = o[p]).length, ~(l = l.replace(/^ *([*+-]|\d+\.) */, "")).indexOf("\n ") && (d -= l.length, l = this.options.pedantic ? l.replace(/^ {1,4}/gm, "") : l.replace(new RegExp("^ {1," + d + "}", "gm"), "")), p !== g - 1 && (s = r.bullet.exec(o[p + 1])[0], (a.length > 1 ? 1 === s.length : s.length > 1 || this.options.smartLists && s !== a) && (e = o.slice(p + 1).join("\n") + e, p = g - 1)), i = n || /\n\n(?!\s*$)/.test(l), p !== g - 1 && (n = "\n" === l.charAt(l.length - 1), i || (i = n)), i && (u.loose = !0), w = void 0, (y = /^\[[ xX]\] /.test(l)) && (w = " " !== l[1], l = l.replace(/^\[[ xX]\] +/, "")), f = {
                                type: "list_item_start",
                                task: y,
                                checked: w,
                                loose: i
                            }, c.push(f), this.tokens.push(f), this.token(l, !1), this.tokens.push({
                                type: "list_item_end"
                            });
                            if (u.loose)
                            ...
                            text: this.options.sanitize ? this.options.sanitizer ? this.options.sanitizer(o[0]) : h(o[0]) : o[0]
                        });
                        else if (t && (o = this.rules.def.exec(e))) e = e.substring(o[0].length), o[3] && (o[3] = o[3].substring(1, o[3].length - 1)), m = o[1].toLowerCase().replace(/\s+/g, " "), this.tokens.links[m] || (this.tokens.links[m] = {
                            href: o[2],
                            title: o[3]
                        });
                        else if ((o = this.rules.table.exec(e)) && (l = {
                                type: "table",
                                header: x(o[1].replace(/^ *| *\| *$/g, "")),
                                align: o[2].replace(/^ *|\| *$/g, "").split(/ *\| */),
                                cells: o[3] ? o[3].replace(/\n$/, "").split("\n") : []
                            ...
                            for (e = e.substring(o[0].length), p = 0; p < l.align.length; p++) /^ *-+: *$/.test(l.align[p]) ? l.align[p] = "right" : /^ *:-+: *$/.test(l.align[p]) ? l.align[p] = "center" : /^ *:-+ *$/.test(l.align[p]) ? l.align[p] = "left" : l.align[p] = null;
                            for (p = 0; p < l.cells.length; p++) l.cells[p] = x(l.cells[p].replace(/^ *\| *| *\| *$/g, ""), l.header.length);
                            this.tokens.push(l)
                    ...
                    function a(e, t) {
                        if (this.options = t || C.defaults, this.links = e, this.rules = o.normal, this.renderer = this.options.renderer || new s, this.renderer.options = this.options, !this.links) throw new Error("Tokens array requires a `links` property.");
                    ...
                    function u(e) {
                        this.tokens = [], this.token = null, this.options = e || C.defaults, this.options.renderer = this.options.renderer || new s, this.renderer = this.options.renderer, this.renderer.options = this.options, this.slugger = new c
                    }
                    ...
                    function p(e, t, n) {
                        ...
                        t && !g.test(n) && (n = function(e, t) {
                            m[" " + e] || (/^[^:]+:\/*[^\/]*$/.test(e) ? m[" " + e] = e + "/" : m[" " + e] = b(e, "/", !0));
                            return e = m[" " + e], "//" === t.slice(0, 2) ? e.replace(/:[\s\S]*/, ":") + t : "/" === t.charAt(0) ? e.replace(/(:\/*[^\/]*)[\s\S]*/, "$1") + t : e + t
                        }(t, n));
                        try {
                    ...
                    o._punctuation = "!\"#$%&'()*+,\\-./:;<=>?@\\[^_{|}~", o.em = d(o.em).replace(/punctuation/g, o._punctuation).getRegex(), o._escapes = /\\([!"#$%&'()*+,\-.\/:;<=>?@\[\]\\^_`{|}~])/g, o._scheme = /[a-zA-Z][a-zA-Z0-9+.-]{1,31}/, o._email = /[a-zA-Z0-9.!#$%&'*+\/=?^_`{|}~-]+(@)[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?(?:\.[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?)+(?![-_])/, o.autolink = d(o.autolink).replace("scheme", o._scheme).replace("email", o._email).getRegex(), o._attribute = /\s+[a-zA-Z:_][\w.:-]*(?:\s*=\s*"[^"]*"|\s*=\s*'[^']*'|\s*=\s*[^\s"'=<>`]+)?/, o.tag = d(o.tag).replace("comment", r._comment).replace("attribute", o._attribute).getRegex(), o._label = /(?:\[[^\[\]]*\]|\\.|`[^`]*`|[^\[\]\\`])*?/, o._href = /<(?:\\[<>]?|[^\s<>\\])*>|[^\s\x00-\x1f]*/, o._title = /"(?:\\"?|[^"\\])*"|'(?:\\'?|[^'\\])*'|\((?:\\\)?|[^)\\])*\)/, o.link = d(o.link).replace("label", o._label).replace("href", o._href).replace("title", o._title).getRegex(), o.reflink = d(o.reflink).replace("label", o._label).getRegex(), o.normal = y({}, o), o.pedantic = y({}, o.normal, {
                    ...
                    }), o.gfm.url = d(o.gfm.url, "i").replace("email", o.gfm._extended_email).getRegex(), o.breaks = y({}, o.gfm, {
                        br: d(o.br).replace("{2,}", "*").getRegex(),
                        text: d(o.gfm.text).replace("\\b_", "\\b_| {2,}\\n").replace(/\{2,\}/g, "*").getRegex()
                    }), a.rules = o, a.output = function(e, t, n) {
                        return new a(t, n).output(e)
                    }, a.prototype.output = function(e) {
                        for (var t, n, r, i, o, s, l = ""; e;)
                            if (o = this.rules.escape.exec(e)) e = e.substring(o[0].length), l += h(o[1]);
                            else if (o = this.rules.tag.exec(e)) !this.inLink && /^<a /i.test(o[0]) ? this.inLink = !0 : this.inLink && /^<\/a>/i.test(o[0]) && (this.inLink = !1), !this.inRawBlock && /^<(pre|code|kbd|script)(\s|>)/i.test(o[0]) ? this.inRawBlock = !0 : this.inRawBlock && /^<\/(pre|code|kbd|script)(\s|>)/i.test(o[0]) && (this.inRawBlock = !1), e = e.substring(o[0].length), l += this.options.sanitize ? this.options.sanitizer ? this.options.sanitizer(o[0]) : h(o[0]) : o[0];
                        else if (o = this.rules.link.exec(e)) {
                            var u = w(o[2], "()");
                            if (u > -1) {
                                var c = 4 + o[1].length + u;
                                o[2] = o[2].substring(0, u), o[0] = o[0].substring(0, c).trim(), o[3] = ""
                            }
                            e = e.substring(o[0].length), this.inLink = !0, r = o[2], this.options.pedantic ? (t = /^([^'"]*[^\s])\s+(['"])(.*)\2/.exec(r)) ? (r = t[1], i = t[3]) : i = "" : i = o[3] ? o[3].slice(1, -1) : "", r = r.trim().replace(/^<([\s\S]*)>$/, "$1"), l += this.outputLink(o, {
                                href: a.escapes(r),
                                title: a.escapes(i)
                            }), this.inLink = !1
                        ...
                        } else if (o = this.rules.strong.exec(e)) e = e.substring(o[0].length), l += this.renderer.strong(this.output(o[4] || o[3] || o[2] || o[1]));
                        else if (o = this.rules.em.exec(e)) e = e.substring(o[0].length), l += this.renderer.em(this.output(o[6] || o[5] || o[4] || o[3] || o[2] || o[1]));
                        ...
                        else if (o = this.rules.autolink.exec(e)) e = e.substring(o[0].length), r = "@" === o[2] ? "mailto:" + (n = h(this.mangle(o[1]))) : n = h(o[1]), l += this.renderer.link(r, null, n);
                        else if (this.inLink || !(o = this.rules.url.exec(e))) {
                            if (o = this.rules.text.exec(e)) e = e.substring(o[0].length), this.inRawBlock ? l += this.renderer.text(this.options.sanitize ? this.options.sanitizer ? this.options.sanitizer(o[0]) : h(o[0]) : o[0]) : l += this.renderer.text(h(this.smartypants(o[0])));
                            else if (e) throw new Error("Infinite loop on byte: " + e.charCodeAt(0))
                        } else {
                        ...
                        return l
                    }, a.escapes = function(e) {
                        return e ? e.replace(a.rules._escapes, "$1") : e
                        ...
                        this.inline = new a(e.links, this.options), this.inlineText = new a(e.links, y({}, this.options, {
                            renderer: new l
                    ...
                    function C(e, t, n) {
                        ...
                        if (n || "function" == typeof t) {
                            n || (n = t, t = null), k(t = y({}, C.defaults, t || {}));
                            var r, o, a = t.highlight,
                                s = 0;
                            try {
                                r = i.lex(e, t)
                            } catch (e) {
                            ...
                            for (; s < r.length; s++) ! function(e) {
                                "code" !== e.type ? --o || l() : a(e.text, e.lang, function(t, n) {
                                    return t ? l(t) : null == n || n === e.text ? --o || l() : (e.text = n, e.escaped = !0, void(--o || l()))
                                })
                            }(r[s])
                        } else try {
                            return t && (t = y({}, C.defaults, t)), k(t), u.parse(i.lex(e, t), t)
                        } catch (e) {
                            if (e.message += "\nPlease report this to https://github.com/markedjs/marked.", (t || C.defaults).silent) return "<p>An error occurred:</p><pre>" + h(e.message + "", !0) + "</pre>";
                            throw e
                        }
                    }
                    v.exec = v, C.options = C.setOptions = function(e) {
                    ...
                    }, C.defaults = C.getDefaults(), C.Parser = u, C.parser = u.parse, C.Renderer = s, C.TextRenderer = l, C.Lexer = i, C.lexer = i.lex, C.InlineLexer = a, C.inlineLexer = a.output, C.Slugger = c, C.parse = C, void 0 !== t && "object" == typeof n ? t.exports = C : e.marked = C
                    ...
                    (i = function(e, t, n, i) {
                        ...
                        function p() {
                            for (c.rules = c._parseAFF(t), c.compoundRuleCodes = {}, a = 0, l = c.compoundRules.length; a < l; a++) {
                                ...
                                for (s = 0, u = e.length; s < u; s++) c.compoundRuleCodes[e[s]] = []
                            }
                            for (a in "ONLYINCOMPOUND" in c.flags && (c.compoundRuleCodes[c.flags.ONLYINCOMPOUND] = []), c.dictionaryTable = c._parseDIC(n), c.compoundRuleCodes) 0 === c.compoundRuleCodes[a].length && delete c.compoundRuleCodes[a];
                        ...
                        _parseAFF: function(e) {
                            ...
                            for (i = 0, a = u.length; i < a; i++) {
                                ...
                                if ("PFX" == h || "SFX" == h) {
                                    ...
                                    for (o = i + 1, s = i + 1 + (n = parseInt(c[1], 10)); o < s; o++) r = (t = u[o]).split(/\s+/), this.compoundRules.push(r[1]);
                                    i += n
                            ...
                            for (var n = t.entries, r = [], i = 0, o = n.length; i < o; i++) {
                                ...
                                if (!a.match || e.match(a.match)) {
                                    ...
                                    if (a.remove && (s = s.replace(a.remove, "")), "SFX" === t.type ? s += a.add : s = a.add + s, r.push(s), "continuationClasses" in a)
                                        for (var l = 0, u = a.continuationClasses.length; l < u; l++) {
                        ...
                        suggest: function(e, t) {
                            ...
                            function l(e) {
                                ...
                                for (t = 0, i = e.length; t < i; t++) {
                                    ...
                                    for (n = 0, o = u.length + 1; n < o; n++) {
                                        ...
                                        if (c[1] && l.push(c[0] + c[1].substring(1)), c[1].length > 1 && c[1][1] !== c[1][0] && l.push(c[0] + c[1][1] + c[1][0] + c[1].substring(2)), c[1])
                                            for (r = 0, a = s.alphabet.length; r < a; r++) s.alphabet[r] != c[1].substring(0, 1) && l.push(c[0] + s.alphabet[r] + c[1].substring(1));
                                        if (c[1])
                                            for (r = 0, a = s.alphabet.length; r < a; r++) l.push(c[0] + s.alphabet[r] + c[1])
                                    }
                                }
                                return l
                            }
                            return s.alphabet = "abcdefghijklmnopqrstuvwxyz", this.memoized[e] = {
                                suggestions: function(e) {
                                    ...
                                    var h = [],
                                        f = "lowercase";
                                    for (e.toUpperCase() === e ? f = "uppercase" : e.substr(0, 1).toUpperCase() + e.substr(1).toLowerCase() === e && (f = "capitalized"), n = 0, r = Math.min(t, c.length); n < r; n++) "uppercase" === f ? c[n][0] = c[n][0].toUpperCase() : "capitalized" === f && (c[n][0] = c[n][0].substr(0, 1).toUpperCase() + c[n][0].substr(1)), s.hasFlag(c[n][0], "NOSUGGEST") || h.push(c[n][0]);
                                    return h
                                }(e),
                                limit: t
        ...
        20: [function(e, t, n) {
            ...
            function w(e) {
                ...
                if ("single" === d) {
                    ...
                    if (u.line !== c.line || u.ch !== c.ch) {
                        ...
                        var w = u.line;
                        if (n(l.getLineHandle(u.line)) && ("fenced" === i(l, u.line + 1) ? (o = u.line, w = u.line + 1) : (a = u.line, w = u.line - 1)), void 0 === o)
                            for (o = w; o >= 0 && !n(f = l.getLineHandle(o)); o--);
                        if (void 0 === a)
                            for (s = l.lineCount(), a = w; a < s && !n(f = l.getLineHandle(a)); a++);
            ...
            function D(e) {
                ...
                _(t, n.link, r.insertTexts.link, i)
            }
            ...
            function F(e) {
                ...
                _(t, n.image, r.insertTexts.image, i)
            }
            ...
            function O(e, t) {
                ...
                _(n, r.image, i.insertTexts.uploadedImage, t), e.updateStatusBar("upload-image", e.options.imageTexts.sbOnUploaded.replace("#image_name#", o)), setTimeout(function() {
            ...
            function I(e) {
                var t = e.codemirror,
                    n = m(t),
                    r = e.options;
                _(t, n.table, r.insertTexts.table)
            }
            ...
            function B(e) {
                var t = e.codemirror,
                    n = m(t),
                    r = e.options;
                _(t, n.image, r.insertTexts.horizontalRule)
            }
            ...
            function j(e, t) {
                if (!/editor-preview-active/.test(e.getWrapperElement().lastChild.className)) {
                    for (var n = /^(\s*)(\*|-|\+|\d*\.)(\s+)/, r = /^\s*/, i = m(e), o = e.getCursor("start"), a = e.getCursor("end"), s = {
                        ...
                        }, u = 1, c = o.line; c <= a.line; c++) ! function(n) {
                        var r = e.getLine(n);
            ...
            ee.prototype.uploadImages = function(e, t, n) {
                ...
                if (e || (e = this.element || document.getElementsByTagName("textarea")[0]), !this._rendered || this._rendered !== e) {
                    ...
                    var t, n, o = this.options,
                        a = this,
                        s = {};
                    for (var u in o.shortcuts) null !== o.shortcuts[u] && null !== l[u] && function(e) {
